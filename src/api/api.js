...
export const updateComment = (commentId, commentData) =>
  api.patch(`/comments/c/${commentId}`, commentData);
...
export const getWatchHistory = () =>
  api.get("/history", { headers: { Authorization: `Bearer ${accessToken}` } });
...
export const updateVideo = (videoId, formData) =>
  api.patch(`/${videoId}`, formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
export const togglePublishStatus = (videoId) =>
  api.patch(`/toggle/publish/${videoId}`);
